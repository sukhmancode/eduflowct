  ...
  return (
    <div className="min-h-[89vh] flex flex-col bg-[#0f172a] text-white rounded-xl shadow-md overflow-hidden">
      ...
      <div className="bg-[#1e293b] border-t border-gray-700 px-6 py-4 flex items-center gap-4">
        <textarea
          className="flex-1 bg-[#0f172a] border border-gray-600 rounded-md p-3 resize-none text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600"
        ...
        />
        <Button
          className="bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 px-6 py-2 font-semibold"
          onClick={handleSend}
          disabled={loading}
        >
